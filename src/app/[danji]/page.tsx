      ...
      <header className="rounded-2xl bg-[#1c1c22] px-6 py-5 text-white shadow-sm">
        <div className="flex items-end justify-between">
          <div>
            ...
            <h1 className="serif mt-1 text-3xl font-bold">{c.이름}</h1>
            <p className="mt-1 text-xs text-[#a99f86]">
              {c.동수}개동 · 동의 {num(c.동의수)} / {num(c.세대수)}명
            </p>
          </div>
          <div className="text-right">
            <div className="serif text-4xl font-extrabold text-[#e8c977]">{pct(c.동의율)}</div>
            <div className="text-[11px] text-[#a99f86]">단지 동의율</div>
          </div>
        </div>
        <div className="mt-4">
          <ProgressBar
